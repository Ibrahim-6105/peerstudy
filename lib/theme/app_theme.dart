// Shared app theme for PeerStudy.
// Colors, buttons, cards, and text styles live here so every screen keeps the
// same visual personality without repeating styling code.
...
class AppTheme {
  ...
  // Builds the dark theme used by MaterialApp.
  // Change colors or common widget styling here first when you want the whole
  // app design to move together.
